 ...
 */
final class Version20260123173452 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE casino_data (id INT AUTO_INCREMENT NOT NULL, player_id INT NOT NULL, game_name VARCHAR(255) NOT NULL, bet_amount INT NOT NULL, won_amount INT NOT NULL, details JSON DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_8EC1944999E6F5DF (player_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE inventory (id INT AUTO_INCREMENT NOT NULL, owner_id INT NOT NULL, item_id INT NOT NULL, quantity INT NOT NULL, INDEX IDX_B12D4A367E3C61F9 (owner_id), INDEX IDX_B12D4A36126F525E (item_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE item (id INT AUTO_INCREMENT NOT NULL, required_item_id INT DEFAULT NULL, name VARCHAR(100) NOT NULL, description LONGTEXT DEFAULT NULL, currency VARCHAR(255) NOT NULL, price INT NOT NULL, type VARCHAR(255) NOT NULL, discord_role_id VARCHAR(50) DEFAULT NULL, quantity INT DEFAULT NULL, required_role_id VARCHAR(50) DEFAULT NULL, position INT NOT NULL, purchase_limit INT DEFAULT NULL, INDEX IDX_1F1B251E338E759E (required_item_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE `user` (id INT AUTO_INCREMENT NOT NULL, discord_id VARCHAR(50) NOT NULL, discord_username VARCHAR(100) DEFAULT NULL, discord_global_name VARCHAR(100) DEFAULT NULL, discord_avatar VARCHAR(100) DEFAULT NULL, email VARCHAR(180) DEFAULT NULL, gems INT NOT NULL, rubies INT NOT NULL, discord_access_token LONGTEXT DEFAULT NULL, discord_refresh_token LONGTEXT DEFAULT NULL, discord_token_expires_at DATETIME DEFAULT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', last_login_at DATETIME DEFAULT NULL, roles JSON NOT NULL, jwt_refresh_token LONGTEXT DEFAULT NULL, jwt_refresh_token_expires_at DATETIME DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE item ADD CONSTRAINT FK_1F1B251E338E759E FOREIGN KEY (required_item_id) REFERENCES item (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE item DROP FOREIGN KEY FK_1F1B251E338E759E');
